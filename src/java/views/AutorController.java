...
public class AutorController implements Serializable {
    ...
    @EJB
    private models.AutorFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;
    
    private List<Pais> listaPaises; // Agrega esta propiedad
    private Pais selectedPais; // Nueva propiedad
 ...
 // Getter para la lista de países
    /*public List<Pais> getListaPaises() {
        return listaPaises;
    }

    // Setter para la lista de países
    ...
    public List<Pais> getListaPaises() {
        if (listaPaises == null) {
            listaPaises = ejbFacade.obtenerListaPaises(); // Inicializa la lista de países si aún no se ha hecho
        }
        return listaPaises;
    }
